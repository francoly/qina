 ...
 * @params   暂无
 */
$.fn.ProvinceCity = function(location){
	var _self = this;
	//定义3个默认值
	var prov = location.prov ? location.prov:'省';
	var cit1 = location.cit1 ? location.cit1:'市';
	var cit2 = location.cit2 ? location.cit2:'区/县';
	_self.data("province",[prov, "省"]);
	_self.data("city1",[cit1, "市"]);
	_self.data("city2",[cit2, "区/县"]);
	//插入3个空的下拉框
